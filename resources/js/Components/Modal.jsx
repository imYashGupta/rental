...
export default function Modal({showTenant, SetShowTenant}) {
    const [open, setOpen] = useState(showTenant)

    useEffect(() => {
        setOpen(showTenant ? true : false);
    }, [showTenant]);
                    ...
                    <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                      ...
                      <div className="mt-2">
                        <p className="text-sm text-gray-500">
                          Details:</p>
                        {showTenant?.phone && <p>Phone: <a href="">{showTenant?.phone}</a></p>}
                        <p>Email: <a href="">Some@mail.com</a></p>
                        <p>From: {showTenant.created_at}</p>
                      </div>
                    </div>
                  </div>
                </div>
